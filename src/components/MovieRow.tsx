      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative group">
          ...
          <motion.div
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 z-20 opacity-100 transition-opacity"
          >
            <Button
              variant="ghost"
              size="icon"
          ...
          <motion.div
            initial={{ opacity: 0 }}
            whileHover={{ scale: 1.1 }}
            className="absolute right-0 top-1/2 -translate-y-1/2 z-20 opacity-100 transition-opacity"
          >
            <Button
              variant="ghost"
              size="icon"
